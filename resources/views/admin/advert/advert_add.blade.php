            ...
            <div class="col-lg-12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div>
                            <form role="form" id="AddData" action="{{route('admin.advert.advert_add_data')}}">
                                <input type="hidden" id="_token" name="_token" value="{{csrf_token()}}">
                                <div class="form-title">
                                    <a href="{{route('admin.advert.advert_list')}}" class="btn btn-info"
                                       data-loader="App-loader" data-loadername="广告列表">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="user_id" class="form-control">
                                        ...
                                        <option value="1">十万粉后台</option>
                                        <option value="2">追梦小窝测试</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>广告名称</label>
                                ...
                                <div class="form-group">
                                    <label>选择上传</label>
                                    <input type="hidden" name="url" id="ad_file">
                                ...
                                <div class="form-group">
                                    <label>宽</label>
                                    <input type="number" name="width" id="width" placeholder="宽" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>高</label>
                                    <input type="number" name="height" id="height" placeholder="高" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>广告单价</label>
                                    <input type="number" name="price" placeholder="广告单价" class="form-control">
                                </div>
                                {{--                                <div class="form-group">--}}
                                {{--                                    <label>投放城市</label>--}}
                                {{--                                    <input type="text" name="city" placeholder="投放城市" class="form-control">--}}
                                {{--                                </div>--}}
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                ...
                                <button type="button" class="btn btn-blue" onclick="postForm()">确认新增</button>
                            </form>
                        </div>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            let $list = $("#thelist"); //这几个初始化全局的百度文档上没说明，好蛋疼。
            let $btn = $("#ctlBtn"); //开始上传。
            let BASE_URL = '/webuploader'; // 添加全局站点信息
        ...
        // 提交表单数据，创建广告
        function postForm() {
            let url = $("#AddData").attr('action');
            let data = $("#AddData").serialize();
